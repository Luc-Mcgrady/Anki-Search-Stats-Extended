...
>
    ...
    <GraphContainer>
        ...
        <p>Retention is used to compare how many cards you got right and wrong on first looking.</p>
    </GraphContainer>
    <GraphContainer>
        <h1>Custom pie</h1>
        <CustomPie />
    ...
    <GraphContainer>
        ...
        <p>
            ...
            {/if}
            is 1/interval for each card and is used to estimate how many cards you see in a day. As an
            example if a card has an interval of 1 it has a {$burdenOrLoad.toLowerCase()} of 1 because
