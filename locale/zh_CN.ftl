...
lapse-distribution-help = 
    当非“学习中”状态的卡片被“重来”时，遗忘次数+1。默认7次遗忘会标记为"记忆难点"，可在牌组设置的"记忆难点阈值"修改
...
suspended-cards-warning = 
    要排除暂停卡片，需手动添加"-is:suspended"到搜索条件。注意与上方图表条件不一致可能导致错误
...
forgotten-cards-not-yet-reintroduced = 未重新引入的遗忘卡片: {$number}
